...
CREATE TABLE `logan_task` (
  ...
  `app_id` varchar(256) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'app标识',
  `union_id` varchar(256) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '用户标识',
  `device_id` varchar(256) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '设备标识',
  `app_version` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'app版本',
  `build_version` varchar(256) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '构建版本',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='上报日志任务表';
...
CREATE TABLE `logan_log_detail` (
  ...
  `content` mediumtext COLLATE utf8mb4_general_ci NOT NULL COMMENT '原始日志',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='日志解析后的数据详情';
